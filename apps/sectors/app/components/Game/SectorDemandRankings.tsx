          ...
          <div className="text-sm text-gray-300 space-y-3">
            <div>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1 ml-2">
                <li>Sector demand = <strong>research slot bonus</strong> + <strong>active marketing demand bonuses</strong> (tier I +1, tier II +1, tier III +2 per campaign while active). Brand score does not change sector demand.</li>
