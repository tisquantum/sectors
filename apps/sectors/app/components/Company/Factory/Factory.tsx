    ...
    >
      ...
      <div className="p-1">
        <div className="flex items-center justify-center gap-1">
          <div className="flex flex-wrap gap-1 justify-center h-7 content-start flex-1">
      ...
      <div className="flex items-center justify-center gap-1 p-1 border-b border-gray-600/30">
        ...
        <Popover placement="top">
          ...
          <PopoverContent>
            <div className="px-1 py-1 max-w-xs">
              <div className="text-small font-semibold mb-1">Factory Revenue</div>
              <div className="text-small text-default-500">
                Sum of all resource prices for this factory. This is the revenue per unit when customers are served.
              </div>
            </div>
          </PopoverContent>
        </Popover>
