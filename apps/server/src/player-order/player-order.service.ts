...
import { Prisma, PlayerOrder, OrderType } from '@prisma/client';
...
export class PlayerOrderService {
  ...
  async createPlayerOrder(data: Prisma.PlayerOrderCreateInput): Promise<PlayerOrder> {
  ...
  async deletePlayerOrder(where: Prisma.PlayerOrderWhereUniqueInput): Promise<PlayerOrder> {
